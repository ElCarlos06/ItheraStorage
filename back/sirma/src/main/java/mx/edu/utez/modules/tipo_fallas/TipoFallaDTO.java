...
/**
 * DTO para operaciones CRUD de tipos de falla en SIRMA.
...
public class TipoFallaDTO {
    ...
    @NotBlank(message = "El nombre del tipo de falla es obligatorio")
    @Size(max = 100, message = "El nombre del tipo de falla no debe exceder 100 caracteres")
