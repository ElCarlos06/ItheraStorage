...
function mapSolicitud(s) {
  ...
  return {
    ...
    activoNombre: activo.numeroSerie ?? "-",
    nombreUsuario:
    ...
    aula: espacio.nombreEspacio ?? s.aula ?? "-",
    prioridad,
...
const PRIORIDAD_STYLES = {
  Alta: {
    background: "var(--color-prioridad-alta,  #99e6da)",
    color: "#065f55",
  },
  Media: {
    background: "var(--color-prioridad-media, #fef08a)",
    color: "#854d0e",
  },
  Baja: {
    background: "var(--color-prioridad-baja,  #e5e7eb)",
    color: "#374151",
  },
};
...
export default function Requests() {
  ...
  paginatedItems.forEach((s) => console.log(s));
                ...
                <div className="requests-view__card">
                  ...
                  <div className="requests-view__card-top">
                    <div className="requests-view__card-id">
                      <p className="requests-view__codigo">
                        {sol.activoNombre}
                      </p>
                      <p className="requests-view__usuario">
                        {sol.nombreUsuario}
                      </p>
                    </div>
