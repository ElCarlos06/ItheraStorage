...
import { X, Download, FileDown, Printer } from "lucide-react";
...
export default function QrAssetModal({ open, onClose, item }) {
  ...
  // Cargar QR cuando el modal se abre
  useEffect(() => {
      ...
      <div className="qr-asset-modal__inner">
        ...
        <div className="qr-asset-modal__card">
          <div className="qr-asset-modal__img-wrap">
            {loading && (
              <>
                <div className="qr-asset-modal__spinner" />
        ...
        <div className="qr-asset-modal__actions">
          <Button
            variant="primary"
            fullWidth
            iconLeft={<Download size={20} strokeWidth={1.5} />}
            disabled={!qrSrc}
          ...
          <Button
            variant="primary"
            fullWidth
            iconLeft={<FileDown size={20} strokeWidth={1.5} />}
            disabled={!qrSrc || pdfLoading}
            onClick={handleDownloadPdf}
          >
            {pdfLoading ? "Descargando…" : "Descargar como PDF"}
          </Button>
          <Button
            variant="outline"
            fullWidth
            iconLeft={<Printer size={20} strokeWidth={1.5} />}
            disabled={!qrSrc}
            onClick={handlePrint}
          >
            Imprimir
